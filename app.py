...
# ================= GOOGLE SHEET IDS =================
BUFFER_SHEET_ID = "PASTE_BUFFER_SHEET_ID"
LOG_SHEET_ID    = "PASTE_LOG_SHEET_ID"
...
menu = st.sidebar.radio(
    "MENU", ["DASHBOARD","FULL BUFFER STOCK","STOCK IN","STOCK OUT","REPORT"]
)
...
# ================= STOCK IN =================
    ...
    if st.button("ADD STOCK"):
        ...
        log_df.loc[len(log_df)] = [
            datetime.today().date(), datetime.now().strftime("%H:%M:%S"),
